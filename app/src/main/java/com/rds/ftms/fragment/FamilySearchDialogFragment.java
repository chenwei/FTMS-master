...
import com.rds.ftms.fragment.adapter.FtmsFamilySearchAdapter;
...
public class FamilySearchDialogFragment extends DialogFragment implements View.OnClickListener {


    private String TAG = FragmentFamilySearch.class.getName();
    private ListView listView;
    private FtmsFamilySearchAdapter adapter;
    ...
    public static FamilySearchDialogFragment newInstance(int p_fid, int p_pid, FamilyTreeActivity3 context) {
        FamilySearchDialogFragment fragment = new FamilySearchDialogFragment(p_fid, p_pid, context);
    ...
    public FamilySearchDialogFragment() {
    ...
    public FamilySearchDialogFragment(int p_fid, int p_pid, FamilyTreeActivity3 context) {
        this.fid = p_fid;
        this.pid = p_pid;
...
//        View view = inflater.inflate(R.layout.fragment_family_member_form, null);
        ...
        View view = inflater.inflate(R.layout.fragment_family_search, null);
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                 ...
                 */
                if (is_divPage && scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && pageNo <= pageCount) {
                    Toast.makeText(getContext(), "正在获取更多数据...",
                     ...
                     */
                    Toast.makeText(getContext(), "没有更多数据啦...",
                            Toast.LENGTH_SHORT).show();
                }
            }
            /**
        ...
        adapter = new FtmsFamilySearchAdapter(context);
        adapter.setFid(fid);
        adapter.setPid(pid);
...
//            List<FtmsFamilyBean> reslut = dao.queryAll();
            ...
            FtmsFamilyDao dao = new FtmsFamilyDao(getContext());
...
//                List<FtmsFamilyBean> list = dao.queryAll();
                ...
                Toast.makeText(getContext(), "请求数据失败...",
