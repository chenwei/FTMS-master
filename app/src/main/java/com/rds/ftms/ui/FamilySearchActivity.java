...
public class FamilySearchActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_family_search);
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (is_divPage && scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && pageNo <= pageCount) {
                    Toast.makeText(getApplicationContext(), "正在获取更多数据...",
                     ...
                     */
                    Toast.makeText(getApplicationContext(), "没有更多数据啦...",
                            Toast.LENGTH_SHORT).show();
                }
            }
            /**
        ...
        adapter = new FtmsFamilySearchAdapter(null);
    }
...
//            List<FtmsFamilyBean> reslut = dao.queryAll();
            ...
            FtmsFamilyDao dao = new FtmsFamilyDao(getApplicationContext());
